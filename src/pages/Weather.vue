...
<template>
  <div class="p-6">
    ...
    <div v-if="weather" class="mt-4 text-center bg-white shadow-md p-4 rounded-md">
    ...
    <div class="mt-6 text-center">
      <button @click="goBack" class="bg-gray-600 text-white px-4 py-2 rounded-md hover:bg-gray-800">
        ← Back to Home
      </button>
    </div>
  </div>
